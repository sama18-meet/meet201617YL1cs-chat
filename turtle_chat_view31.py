...
class TextBox(TextInput):
    ...
    def write_msg(self):
        self.writer.goto(self.pos[0]-self.width/2+5,self.pos[1]-self.height/2-12)
...
class View:
    ...
    def __init__(self,username='Me',partner_name='Sama',partner_pic="profile.gif",bg_pic="meet3.gif"):
